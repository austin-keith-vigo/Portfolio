...
let vgdcGameData = {
    ...
    projectSummary:
    "This was my first project I commited extra-curricular time to completing. Along, with 5 other programmers, we completed a 2D-Platformer using the Unity Engine.\n\n\tHeading into this project I knew nothing about game-development and Unity, and I was not the only one. We were all beginners. I was voted to be the leader of the group, which as time passed grew to be a more difficult task. I was the one to lead the group in the learning stage where we all taught ourselves Unity. Along with this responsibility, I delegated out features and made sure these features were finished on time. If not, I would flex team-members to alleviate the blocker. It felt like an Agile Software Development process, but I did not know this at the time. Lastly, I managed the GitHub repo, resolving merge conflicts and approving pull requests.\n\n\tAs stated before, being that we were all beginners, it was difficult to learn and implement new things at the same time. But seeing the finished product and letting other people play it, made our success all that much more satisfying. This project really made me flex my leadership and communication skills, and it was a great learning opportunity for me to improve in these areas.",
